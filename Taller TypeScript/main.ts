...
function hacerTabla(): void {
    ...
    if (tabla) {
        series.forEach((serie) => {
            ...
            const show: HTMLElement | null = fila.querySelector('.show-card');
            if (show){
...
function hacerPromedio(): void {
    const resumen: HTMLElement | null = document.querySelector('span');
